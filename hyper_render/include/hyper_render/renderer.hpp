...
namespace hyper_render
{
    ...
    {
    public:
        Renderer(hyper_event::EventBus &event_bus, const hyper_platform::Window &window, const RendererDescriptor &descriptor);
    ...
    private:
        ...
        void on_mouse_move(const hyper_platform::MouseMoveEvent &event);
        void on_mouse_scroll(const hyper_platform::MouseScrollEvent &event);
